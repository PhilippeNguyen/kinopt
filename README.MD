...
With this, you will be able to compare the feature visualization of any keras model. For example, you can have different models draw bees:
...
*  --output: name of the output png to save the optimized input image.
